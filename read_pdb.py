...
@writer
def write_proteindatabank(fileobj, images, atom_names, resnr, write_arrays=True):
    ...
    format = ('ATOM  %5d %4s CBZ %5d    %8.3f%8.3f%8.3f%6.2f%6.2f'
              '          %2s  \n')
    ...
    for n, atoms in enumerate(images):
        ...
        for a in range(natoms):
            ...
            occ = occupancy[a]
            bf = bfactor[a]
            fileobj.write(format % ((a+1) % MAXNUM, atom_names[a], resnr[a],
